...
public class UserRegistration {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isValidMobileNumber.validate("^[91]+[ ]?[6-9]{1}[0-9]{9}$", "91 7712312312"));
